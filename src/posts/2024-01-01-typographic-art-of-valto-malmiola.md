...
The so-called "good typography" is often adhered to in an overly dogmatic manner, leading to the sidelining of non-conformist practices in the canon of typographic history. My aim is to highlight the more joyous and delightful aspects of typography found in **pictorial typesetting**—the art of arranging printing type into decorative patterns or pictorial compositions. 

I start with Valto Malmiola (1893–1950), as he is the only *Finnish* typographer I know who has extensively explored this style. However, there are many typographers (including typesetters, compositors, apprentices, type founders etc.) worldwide and throughout centuries who have practiced pictorial typography. These artists, like Malmiola, defied norms and pushed the boundaries of what is thought possible, by transforming the printing press into an expressive artistic medium. Their work showcases the potential of typography as an art form, but their contributions have often been overlooked or underappreciated in the broader narrative of typographic development *and* of art. By writing about these artists I hope to offer a new, more playful perspective on what we think of as "typography".
...
<figure class="u-image-small">
    {% image
        "./src/assets/images/malmiola/sibelius-forme.jpg",
        "",
...
Instead of using brass rules conventionally, Malmiola used them like building blocks. By carefully arranging rules of varying thicknesses in horizontal and vertical lines, he transformed these simple metal strips into a complex yet coherent picture.
 ...
 <figure class="u-image-full-width">
    {% image
        ...
        [300, 600]
    %}
    <figcaption>Figure 5. Extreme closeup of the face shows the inidivual elements and their positioning.</figcaption>
</figure>
...
<figure class="u-image-full-width">
    {% image
        ...
        [300, 600]
    %}
    <figcaption>Figure 18. Franklin D. Roosevelt, composed of 17,000 monotype characters in The Inland Printer for May, 1935</figcaption>
</figure>
...
Fasol's art deserves an in-depth article in itself. Beyond Fasol, there are many other typographers who have used rules and other type elements to create pictorial typography in various delightful ways: for example Georg Wolffger already in 1670, Monpied and Moulinet in ~1840's and the whole trend of "bending" and "twisting" rules into all kinds of shapes in the 1870–1890's. While a detailed exploration of this phenomena would be required to put Malmiola's work into proper context, it falls outside the scope of this post.
...
Experimenting with pictorial typesetting was not always met with enthusiasm. At the time, it was often dismissed as mere "trickery" or childish dabbling, not just by traditionalists, but also by the rising avant-garde of typography. Pictorial typesetting had become a typographic trend in 1930's Germany, but Jan Tschichold's hugely influential book *The New Typography*, published in 1928, strictly forbade the use of *any* decorative figures or pictorial compositions made with type elements.
...
Both the avant-garde and traditionalists viewed typographic experimentation, like what Malmiola was doing, as frivolous or detracting from the primary purpose of type: clear communication. 
...
His son [Orla Valdemar Malmiola](https://www.geni.com/people/Orla-Valdemar-Malmiola/6000000172433316929) (1919-1995) worked as a printing house foreman.
...
* Figure 1. Malmiola, Valto. *Sibelius*. 1937. Letterpress forme of brass rule and spacing material. Photograph by Antti Auvinen, 2015
...
* Figure 5.  Malmiola, Valto. *Sibelius*. 1937. Letterpress print, 28 × 37,5 cm. Photograph by Heikki Lotvonen, December 2023.
