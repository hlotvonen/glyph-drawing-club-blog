const fontOrder = [
    ...
    "crt8002-005",
    "trs80-model1",
    "trs80-model1-lowercase",
    "mc6674",
    "mc6670p",
    "trs80-dt1",
    "mera-elzab-meritum-lowercase",
    "mera-elzab-meritum",
    "apple_iigs",
    ...
    "saa5050-semigraphics-noncontiguous",
    "acorn_bbc_teletext_graphics_contiguous",
    "saa5054-belgium",
    "saa5050-semigraphics-contiguous",
    "saa5052-sweden",
    "saa5053-italy",
    "saa5051-germany",
    "saa5057-cyrillic",
...
class CharacterViewer extends HTMLElement {
  constructor() {
    super();
...
customElements.define('character-viewer', CharacterViewer);